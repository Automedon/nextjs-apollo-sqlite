...
- Использование Redux (Redux-Thunk, Redux-Saga) для хранения состояния. :heavy_check_mark:
- Использование чистого SQL для создания БД и работы с данными. :heavy_check_mark:
- Использование React Router на клиенте. :heavy_check_mark:
- Добавление постраничного разбиения списка пользователей в личном кабинете. :x:
- Хранение паролей в хэшированном виде, например с использованием bcrypt. :heavy_check_mark:
- Добавление серверного рендеринга. :heavy_check_mark:
- Динамическая валидация полей на клиенте, например логин от 3 до 15 символов, пароль от 5 до 100. :heavy_check_mark:
- Использование pm2 для запуска в промышленном режиме. :heavy_check_mark:
- Искапсуляция CSS: CSS in JS, CSS modules и пр. :heavy_check_mark:
